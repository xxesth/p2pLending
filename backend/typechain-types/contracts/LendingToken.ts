...
export interface LendingTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "allowance"
      | "approve"
...
export interface LendingToken extends BaseContract {
  connect(runner?: ContractRunner | null): LendingToken;
  waitForDeployment(): Promise<this>;

  interface: LendingTokenInterface;
